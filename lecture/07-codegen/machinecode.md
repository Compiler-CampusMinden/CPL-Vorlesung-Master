...
*Anmerkung*: In der obigen Skizze wird der *PC* für jede Instruktion oder jeden
...
Da in einer Instruktion wie `ldr r0, x` die Adresse von `x` mit codiert werden muss,
