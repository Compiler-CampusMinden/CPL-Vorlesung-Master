...
[Nested Scopes: Eigene Modellierung nach einer Idee in [@Parr2010, p. 142]]{.credits
nolist="true"}
...
[Nested Scopes: Eigene Implementierung nach einer Idee in [@Parr2010,
p. 169]]{.credits nolist="true"}
